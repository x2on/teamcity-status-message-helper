# teamcity-status-message-helper [![Build Status](https://travis-ci.org/x2on/teamcity-status-message-helper.png)](https://travis-ci.org/x2on/teamcity-status-message-helper)
